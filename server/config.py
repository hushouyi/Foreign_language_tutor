...
WEB_HOST = "0.0.0.0"       # 监听地址（0.0.0.0 允许局域网访问）
WEB_PORT = 5000             # 端口号
...
SEARCH_CAPABILITY_PROMPT = (
    ...
    "  用户分享个人经历、日常问候、一般性建议。\n"
    "拒绝搜索的情况：任何涉及色情、不当内容、物化他人、\n"
    "  冒犯性或歧视性的话题，直接返回 SEARCH_NOT_NEEDED。\n"
    "\n"
    "先做决策，只输出一行，不要输出其他内容：\n"
...
SEARCH_DECISION_PROMPT = (
    ...
    "NEVER search for: sexual content, explicit material, body objectification,\n"
    "  offensive/harassing topics, or anything inappropriate.\n"
    "  Return SEARCH_NOT_NEEDED for these.\n"
    "\n"
