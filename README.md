...
└─────────────────────────────────────────────────────┘
  ...
  Alice thinking...
  ┌─ Alice [English] ──────────────────────────────────┐
  │  Oh, I just went for a walk in Central Park.       │
  │  The weather was perfect!                          │
  │                                                    │
  │  [中文] 哦，我刚去中央公园散步了。天气超好！        │
  └────────────────────────────────────────────────────┘
  ┌─ Alice [English] ──────────────────────────────────┐
...
Alice [English]
┌─────────────────────────────────────────────────────┐
│  Do you want to switch to Japanese?                 │
│  Just say yes or no.                                │
└─────────────────────────────────────────────────────┘
...
> 推荐使用 **Windows Terminal** 以获得最佳中文显示效果。
...
当前回复开始播放时会自动切断上一个语音。如果仍然遇到问题，检查是否有其他程序占用音频设备。
...
```
├── main.py                 # 入口（rich 面板 UI、逐段显示、后台 TTS）
